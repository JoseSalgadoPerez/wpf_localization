...
namespace wpf_localization.Converters
{
    public class InputArguments
    {
        ...
        protected virtual CultureInfo GetCultureValue(string key) 
        {
            CultureInfo cultureInfo = new CultureInfo(Properties.Settings.Default.DefaultCulture.ToString());
            string strCultureInfo = this.GetValue(key);
            if (strCultureInfo != null)
            {
                return cultureInfo = new CultureInfo(strCultureInfo);
            }
